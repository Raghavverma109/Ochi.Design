...
const Footer = () => {
    return (
        <div  className='w-full h-full flex  bg-zinc-900 px-20 py-10  font-["Founders_Grotesk"]'>
            <div className='w-1/2 h-full flex flex-col justify-between  font-bold -tracking-tighter'>
                <div className='heading '>
                    <h1 className='text-[6vw] font-semibold uppercase leading-none tracking-tighter -mb-5 '>eye-</h1>
                    <h1 className='text-[6vw] font-semibold uppercase leading-none tracking-tighter'>opening </h1>
                </div>
                <svg className='mt-[73vh]' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='w-1/2' >
                <h1 className='text-[6vw] font-semibold uppercase tracking-tighter'>
                    presentations
                </h1>
                <div className='links flex flex-col font-["Neue_Montreal"]'>S:
                    <a className='block text-xl font-light pt-10' href="#">Instagram</a>
                ...
                <div className='links flex flex-row justify-between font-["Neue_Montreal"] py-8'>
                    <div className=''>L:
                        <a className='block text-xl font-light pt-10' href="#" >202-1965 W 4th Ave</a>
                        <a className='block text-xl font-light' href="#">Vancouver, Canada</a>
                        <a className='block text-xl font-light pt-10' href="#"  >30 Chukrina St</a>
                        <a className='block text-xl font-light' href="#">Lviv, Ukraine</a>
                    </div>
                    <div className=''  >M:
                        <a className='block text-xl font-light pt-10' href="#">Services</a>
                ...
                <div className='font-["Neue_Montreal"]'>E:
                    <a className='block text-xl font-light py-8' href="#" >hello@ochi.design</a>
                </div>

                <div className='flex items-center justify-between font-["Neue_Montreal"]'>
                    <a className='block text-xl font-light py-8 text-zinc-700' href="#" >© ochi design 2025. Legal Terms</a>
                    <a className='block text-xl font-light py-8 text-zinc-700' href="#" >Website by Obys</a>
                </div>
